...
import ru.yandex.practicum.task_tracker.exceptions.TaskValidationException;
...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    public void throwGetTaskWithIncorrectIdTest() {
        var exception = assertThrows(ManagerSaveException.class,
                () -> manager.getTask(5));
        assertEquals("Задача с указанным ID не обнаружена.", exception.getMessage());
    }
    ...
    public void throwGetSubTaskWithIncorrectIdTest() {
        ...
        assertEquals("Подзадача с указанным ID не обнаружена.", exception.getMessage());
    }
    ...
    public void throwGetEpicWithIncorrectIdTest() {
        var exception = assertThrows(ManagerSaveException.class,
                () -> manager.getEpic(10));
        assertEquals("Эпик с указанным ID не обнаружен.", exception.getMessage());
    }
